...
import Context, { PhotosState } from "./context-ui";

const ProviderUI: React.FC<{ children: ReactNode | ReactNode[] }> = (props) => {
  ...
  const addingProjectModeHandler = useCallback((boolean: boolean) => setAddingProjectMode(boolean), []);
