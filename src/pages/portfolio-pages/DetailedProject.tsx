...
const DetailedProject = () => {
  ...
  const { curProjects, curProjectHandler, curProjectNo, curProjectNoHandler, curImagesHandler } =
    useContext(ContextProjects);
  const params = useParams();
  useKey();

  useEffect(() => {
    const projectIndex = curProjects.findIndex((project) => project.id === params.projectId);
  ...
  }, [curProjects, curProjectNoHandler, params.projectId, curImagesHandler, curProjectNo, curProjectHandler]);
